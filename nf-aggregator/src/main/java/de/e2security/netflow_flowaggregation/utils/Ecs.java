...
public final class Ecs {
	public static class Schema {
		public enum Netflow {
			...
			IN_FLOW_SEQ_NUM("netflow.inbound.sequence_number"), //custom impl. -> not in 0.1.0 ecs.version yet 	
			IN_FLOW_RECORDS("netflow.inbound.records"),	//custom impl. -> not in 0.1.0 ecs.version yet
			OUT_FLOW_SEQ_NUM("netflow.outbound.sequence_number"), //custom impl. -> not in 0.1.0 ecs.version yet
			OUT_FLOW_RECORDS("netflow.outbound.records"), //custom impl. -> not in 0.1.0 ecs.version yet					
			...
			IN_TCP_FLAGS("network.inbound.tcp_flags"), //custom impl. -> not in 0.1.0 ecs.version yet					
			OUT_TCP_FLAGS("network.outbound.tcp_flags"), //custom impl. -> not in 0.1.0 ecs.version yet				
