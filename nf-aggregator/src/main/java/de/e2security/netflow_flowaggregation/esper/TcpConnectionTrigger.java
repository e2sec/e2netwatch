...
public class TcpConnectionTrigger implements UpdateListener {

	private static final Logger LOG = LoggerFactory.getLogger(TcpConnectionTrigger.class);
	private final CustomKafkaProducer<Serializable, Serializable> producer;
	
	public TcpConnectionTrigger(CustomKafkaProducer<Serializable, Serializable> producer) {
