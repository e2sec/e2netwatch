...
@ComponentScan(basePackages = { "hr.eito.kynkite.usermanagement" })
@EnableJpaRepositories(basePackages = "hr.eito.kynkite.usermanagement.dao")
...
public class UserJpaConfig {
    ...
    public LocalContainerEntityManagerFactoryBean userEntityManager() {
        ...
        em.setPackagesToScan(new String[] { "hr.eito.kynkite.usermanagement.model" });
