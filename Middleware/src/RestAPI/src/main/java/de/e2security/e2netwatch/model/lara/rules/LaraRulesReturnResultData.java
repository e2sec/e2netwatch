...
import de.e2security.e2netwatch.model.ByteSerializer;
...
import de.e2security.e2netwatch.model.lara.rules.dto.out.FlowOut;

/**
 * Return entity for Lara Rules data record
 * 
 * @author Hrvoje
 *
 */
public class LaraRulesReturnResultData {
	...
	public LaraRulesReturnResultData(final RulesetDetails rulesetDetails) {
