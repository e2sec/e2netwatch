...
@ComponentScan(basePackages = { "de.e2security.e2netwatch.aql" })
@EnableJpaRepositories(basePackages = "de.e2security.e2netwatch.aql.dao")
...
public class AqlJpaConfig {
    ...
    public LocalContainerEntityManagerFactoryBean aqlEntityManager() {
        ...
        em.setPackagesToScan(new String[] { "de.e2security.e2netwatch.aql.model" });
