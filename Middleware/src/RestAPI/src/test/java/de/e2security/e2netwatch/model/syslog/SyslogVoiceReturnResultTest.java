...
import de.e2security.e2netwatch.model.Hit;
import de.e2security.e2netwatch.model.Hits;
...
/**
 * Tests the SyslogVoiceReturnResult.
 *
...
@ActiveProfiles("test")
public class SyslogVoiceReturnResultTest {
	...
	public void testEmptyResults() {
		...
		QueryResult<SyslogVoiceQueryResultField> q = new QueryResult<SyslogVoiceQueryResultField>();

		SyslogVoiceReturnResult d = new SyslogVoiceReturnResult(q);
	...
	public void testBrokenResults_00() {
		Hits<SyslogVoiceQueryResultField> h = new Hits<SyslogVoiceQueryResultField>();
	...
	public void testBrokenResults_01() {
		List<Hit<SyslogVoiceQueryResultField>> hits = new ArrayList<Hit<SyslogVoiceQueryResultField>>();
		hits.add(new Hit<SyslogVoiceQueryResultField>());
